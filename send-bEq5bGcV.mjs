import { j as x, l as b, a as D, C as g, o as j, ai as l, m as c, R as h, N as F, M as q, S as y, d as Q, y as X, F as K, r as Y, k as J, ap as z, aq as H, E as Z } from "./index-DKNltDvP.mjs";
import { n as d, r as u } from "./class-map-DWmnpxTI.mjs";
import { c as v, U as N } from "./index-lXSzxGsb.mjs";
import "./index-C9RCk869.mjs";
import "./index-D9uLo7Tj.mjs";
import "./index-Dk0Zjac7.mjs";
import { e as L, n as M } from "./ref-CzOvar1n.mjs";
import "./index-Bpb_IMt4.mjs";
import "./index-DgnbtPXE.mjs";
import "./index-CGYv3Ykd.mjs";
import { S as G } from "./SwapController-B7Wa6WgH.mjs";
...
let $ = class extends b {
  constructor() {
    super(...arguments), this.inputElementRef = L(), this.instructionElementRef = L(), this.readOnly = !1, this.instructionHidden = !!this.value, this.pasting = !1, this.onDebouncedSearch = D.debounce(async (t) => {
      if (!t.length) {
...
let f = class extends b {
  ...
  async handleSendParameters() {
    ...
    if (!Q.SEND_PARAMS_SUPPORTED_CHAINS.includes(i)) {
...
let m = class extends b {
  ...
  async onSendClick() {
    ...
    try {
      ...
      const r = t instanceof z && t.originalName === H.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST, o = t instanceof z && t.originalName === H.PROVIDER_RPC_ERROR_NAME.SEND_TRANSACTION_ERROR;
      (r || o) && (i = t.message), Z.sendEvent({
        type: "track",
...
//# sourceMappingURL=send-bEq5bGcV.mjs.map
