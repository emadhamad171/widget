import { C as g, N as w, S as y, g as A, a as S, b as u, B as N, A as m } from "./core-DIJ1O3gp.mjs";
class p {
  constructor(e) {
...
class E {
  ...
  async request({ method: e, key: t, query: n, body: s, headers: o }) {
    var f;
    const { projectId: r, st: h, sv: k } = this.getSDKProperties(), a = new URL(`${S.W3M_API_URL}/auth/v1/${String(t)}`);
  ...
  setAppKitAccountUser(e) {
    const { email: t } = e;
    t && Object.values(S.CHAIN).forEach((n) => {
...
//# sourceMappingURL=features-HWuGdknB.mjs.map
