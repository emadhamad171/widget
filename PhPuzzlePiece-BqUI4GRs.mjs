import { n as H, Y as V, t, p as n, O as o, s as c } from "./property-Bd8U3_QP.mjs";
var v = Object.defineProperty, g = Object.getOwnPropertyDescriptor, s = (r, A, i, h) => {
  for (var e = h > 1 ? void 0 : h ? g(A, i) : A, p = r.length - 1, l; p >= 0; p--)
    (l = r[p]) && (e = (h ? l(A, i, e) : l(e)) || e);
  return h && e && v(A, i, e), e;
};
...
//# sourceMappingURL=PhPuzzlePiece-BqUI4GRs.mjs.map
