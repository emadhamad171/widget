import { n as v, Y as n, t, p as g, O as s, s as Z } from "./property-Bd8U3_QP.mjs";
var c = Object.defineProperty, m = Object.getOwnPropertyDescriptor, r = (e, o, l, i) => {
  for (var a = i > 1 ? void 0 : i ? m(o, l) : o, p = e.length - 1, V; p >= 0; p--)
    (V = e[p]) && (a = (i ? V(o, l, a) : V(a)) || a);
  return i && a && c(o, l, a), a;
};
let h = class extends v {
  ...
  render() {
    ...
    >
      ${h.weightsMap.get((e = this.weight) != null ? e : "regular")}
    </svg>`;
  }
};
...
h = r([
  Z("ph-currency-dollar")
], h);
export {
  h as PhCurrencyDollar
};
//# sourceMappingURL=PhCurrencyDollar-BekVYPtC.mjs.map
