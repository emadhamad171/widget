import { j as y, r as v, k as N, l as x, m as u, C as c, S as w, F as h, T as f, t as R, W as A, R as S, a as I } from "./index-DKNltDvP.mjs";
import { n as $, r as b } from "./class-map-DWmnpxTI.mjs";
import { o as T } from "./if-defined-CkYnLk1h.mjs";
import { c as C, U as O } from "./index-lXSzxGsb.mjs";
...
let d = class extends x {
  constructor() {
    ...
    super(), this.unsubscribe = [], this.address = (t = c.getAccountData()) == null ? void 0 : t.address, this.profileName = (o = c.getAccountData()) == null ? void 0 : o.profileName, this.network = c.state.activeCaipNetwork, this.unsubscribe.push(c.subscribeChainProp("accountState", (i) => {
      i ? (this.address = i.address, this.profileName = i.profileName) : w.showError("Account not found");
  ...
  render() {
    ...
    const t = h.getNetworkImage(this.network);
    return u` <wui-flex
  ...
  networkTemplate() {
    ...
    if (R(i == null ? void 0 : i.chainNamespace) === A.ACCOUNT_TYPES.SMART_ACCOUNT && o)
    ...
    const n = ((a = s == null ? void 0 : s.filter((l) => {
      var k;
      return (k = l == null ? void 0 : l.assets) == null ? void 0 : k.imageId;
    })) == null ? void 0 : a.slice(0, 5)).map(h.getNetworkImage).filter(Boolean);
  ...
  onCopyClick() {
    try {
      this.address && (I.copyToClopboard(this.address), w.showSuccess("Address copied"));
    } catch {
...
d = m([
  C("w3m-wallet-receive-view")
], d);
export {
  d as W3mWalletReceiveView
};
//# sourceMappingURL=receive-D-xfqDfG.mjs.map
