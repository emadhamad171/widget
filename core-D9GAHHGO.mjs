import { bl as Jt, bm as gi, s as Ye, p as Pe, i as st, G as mi, bn as _l, bo as Ti, bp as Ru, aX as Wn, aI as Yo, aK as Uu, aM as $t, aN as gt, aJ as B, aL as Ss, aV as Du, aW as $u, aS as ci, aT as oo, bq as qn, aR as Lu, aU as Bu, aY as mn, aZ as Tl, a_ as St, a$ as Fu, b0 as Mu, b1 as _t, b8 as ns, b9 as jn, bb as Jo, bc as Wu, bd as Xo, be as Zo, bf as yi, bg as Qo, b2 as Aa, b3 as qu, b4 as ju, b5 as Hu, b6 as Ia, ba as an, bh as Ol, bi as ps, b7 as ts, bj as Os, bk as kl, n as Ms, br as ss, bs as Na, bt as Oi, bu as Sa } from "./index-DIokOUOA.mjs";
import { f as Ku, r as Vu } from "./index-DLVuXqPN.mjs";
const xl = {
...
async function xa() {
  if (!kr) {
    const { createPublicClient: t, http: e, defineChain: s } = await import("./index-BddN6LfB.mjs").then((n) => n.i);
    kr = {
...
class hv {
  ...
  async initialize(e) {
    ...
    if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), (s = e.features) != null && s.headless && !rt.hasInjectedConnectors() && V.prefetch({
      ...
      const { ReownAuthentication: c } = await import("./features-DtnYKu4b.mjs"), l = A.state.siwx;
...
class xu extends hv {
  ...
  async injectModalUi() {
    if (!Sl && W.isClient()) {
      if (await import("./basic-Db9-_oCy.mjs"), await import("./w3m-modal-DLuyhGSw.mjs"), !document.querySelector("w3m-modal")) {
...
//# sourceMappingURL=core-D9GAHHGO.mjs.map
