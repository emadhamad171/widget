import { j as C, r as O, k as P, l as b, m as l, n as E, L as g, R as S, z as x, a as R, S as $ } from "./index-DHmMKAfZ.mjs";
import { n as h, r as d } from "./class-map-B6nE1eS1.mjs";
import { c as v, U as T } from "./index-mXeXqCx8.mjs";
...
m([
  h({ type: Number })
], p.prototype, "length", void 0);
m([
  h({ type: String })
], p.prototype, "otp", void 0);
m([
  d()
], p.prototype, "values", void 0);
p = m([
  v("wui-otp")
], p);
const k = E`
...
let u = w = class extends b {
  ...
  constructor() {
    var t;
    super(), this.loading = !1, this.timeoutTimeLeft = g.getTimeToNextEmailLogin(), this.error = "", this.otp = "", this.email = (t = S.state.data) == null ? void 0 : t.email, this.authConnector = x.getAuthConnector();
  }
  render() {
    if (!this.email)
    ...
    try {
      if (this.onOtpResend) {
        if (!this.loading && !this.timeoutTimeLeft) {
          if (this.error = "", this.otp = "", !x.getAuthConnector() || !this.email)
...
//# sourceMappingURL=index-C2ama_Py.mjs.map
