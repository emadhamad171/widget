import { j as d, r as m, k as c, l as f, v, m as h } from "./index-DHmMKAfZ.mjs";
import { n as r } from "./class-map-B6nE1eS1.mjs";
import { e as y, n as b } from "./ref-cmmbpERb.mjs";
import { c as g, U as w } from "./index-mXeXqCx8.mjs";
const x = d`
  :host {
    position: relative;
...
let i = class extends f {
  constructor() {
    super(...arguments), this.inputElementRef = y(), this.disabled = !1, this.value = "", this.placeholder = "0", this.widthVariant = "auto", this.maxDecimals = void 0, this.maxIntegers = void 0, this.fontSize = "h4", this.error = !1;
  }
  firstUpdated() {
    this.resizeInput();
  }
  updated() {
    this.style.setProperty("--local-font-size", v.textSize[this.fontSize]), this.resizeInput();
  }
  render() {
    var e;
...
//# sourceMappingURL=index-dLUME7xZ.mjs.map
