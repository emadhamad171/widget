import { ar as ye, j as oe, l as se, m as w, r as Ce, C as pe, as as F, a as xe, R as Fe, O as Re, E as Ne, t as Le, W as je } from "./index-CmqJ8p7x.mjs";
import { n as I, r as Q } from "./class-map-BpVMWpIj.mjs";
import { U as Te, c as ae } from "./index-Sp9n1SSe.mjs";
import "./index-CER3L_oS.mjs";
import "./index-R1q12EmT.mjs";
import { o as ke } from "./if-defined-C93kmvJY.mjs";
import "./index-VZr1VrJn.mjs";
import "./index-DCffZbtR.mjs";
var me = { exports: {} }, ze = me.exports, Ie;
function Ue() {
  return Ie || (Ie = 1, (function(e, t) {
    (function(i, r) {
      ...
      var i = 1e3, r = 6e4, o = 36e5, n = "millisecond", s = "second", u = "minute", g = "hour", p = "day", y = "week", $ = "month", j = "quarter", D = "year", R = "date", Y = "Invalid Date", X = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, ee = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, te = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(h) {
        ...
        return { M: $, y: D, w: y, d: p, D: R, h: g, m: u, s, ms: n, Q: j }[h] || String(h || "").toLowerCase().replace(/s$/, "");
      }, u: function(h) {
        return h === void 0;
      } }, S = "en", O = {};
      O[S] = te;
      var V = "$isDayjsObject", B = function(h) {
        return h instanceof le || !(!h || !h[V]);
      }, ce = function h(l, a, d) {
        var c;
        if (!l) return S;
        if (typeof l == "string") {
        ...
        return !d && c && (S = c), c || !d && S;
      }, _ = function(h, l) {
        if (B(h)) return h.clone();
        var a = typeof l == "object" ? l : {};
        return a.date = h, a.args = arguments, new le(a);
      }, x = q;
      x.l = ce, x.i = B, x.w = function(h, l) {
        return _(h, { locale: l.$L, utc: l.$u, x: l.$x, $offset: l.$offset });
      };
      var le = (function() {
        function h(a) {
          this.$L = ce(a.locale, null, !0), this.parse(a), this.$x = this.$x || a.x || {}, this[V] = !0;
        }
        var l = h.prototype;
        return l.parse = function(a) {
          ...
          return _(a) < this.startOf(d);
        }, l.isBefore = function(a, d) {
          return this.endOf(d) < _(a);
        }, l.$g = function(a, d, c) {
          ...
          var c = this, m = !!x.u(d) || d, f = x.p(a), v = function(P, A) {
            var z = x.w(c.$u ? Date.UTC(c.$y, A, P) : new Date(c.$y, A, P), c);
            return m ? z : z.endOf(p);
          }, b = function(P, A) {
            return x.w(c.toDate()[P].apply(c.toDate("s"), (m ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(A)), c);
          }, T = this.$W, M = this.$M, C = this.$D, J = "set" + (this.$u ? "UTC" : "");
          switch (f) {
            case D:
              return m ? v(1, 0) : v(31, 11);
            case $:
              return m ? v(1, M) : v(0, M + 1);
            case y:
              var W = this.$locale().weekStart || 0, re = (T < W ? T + 7 : T) - W;
              return v(m ? C - re : C + (6 - re), M);
            case p:
            case R:
              return b(J + "Hours", 0);
            case g:
          ...
          var c, m = x.p(a), f = "set" + (this.$u ? "UTC" : ""), v = (c = {}, c[p] = f + "Date", c[R] = f + "Date", c[$] = f + "Month", c[D] = f + "FullYear", c[g] = f + "Hours", c[u] = f + "Minutes", c[s] = f + "Seconds", c[n] = f + "Milliseconds", c)[m], b = m === p ? this.$D + (d - this.$W) : d;
          if (m === $ || m === D) {
            var T = this.clone().set(R, 1);
            T.$d[v](b), T.init(), this.$d = T.set(R, Math.min(this.$D, T.daysInMonth())).$d;
          } else v && this.$d[v](b);
          ...
          var c, m = this;
          a = Number(a);
          var f = x.p(d), v = function(M) {
            var C = _(m);
            return x.w(C.date(C.date() + Math.round(M * a)), m);
          };
          if (f === $) return this.set($, this.$M + a);
          if (f === D) return this.set(D, this.$y + a);
          if (f === p) return v(1);
          if (f === y) return v(7);
          var b = (c = {}, c[u] = r, c[g] = o, c[s] = i, c)[f] || 1, T = this.$d.getTime() + a * b;
          return x.w(T, this);
          ...
          var m = a || "YYYY-MM-DDTHH:mm:ssZ", f = x.z(this), v = this.$H, b = this.$m, T = this.$M, M = c.weekdays, C = c.months, J = c.meridiem, W = function(A, z, ne, de) {
            return A && (A[z] || A(d, m)) || ne[z].slice(0, de);
          }, re = function(A) {
            return x.s(v % 12 || 12, A, "0");
          }, P = J || function(A, z, ne) {
            var de = A < 12 ? "AM" : "PM";
            return ne ? de.toLowerCase() : de;
          };
          return m.replace(ee, (function(A, z) {
            return z || (function(ne) {
              switch (ne) {
                ...
                case "d":
                  return String(d.$W);
                case "dd":
                  return W(c.weekdaysMin, d.$W, M, 2);
                case "ddd":
                  return W(c.weekdaysShort, d.$W, M, 3);
                case "dddd":
                  return M[d.$W];
                case "H":
                  return String(v);
          ...
          var m, f = this, v = x.p(d), b = _(a), T = (b.utcOffset() - this.utcOffset()) * r, M = this - b, C = function() {
            return x.m(f, b);
          };
          switch (v) {
            case D:
      ...
      return _.prototype = _e, [["$ms", n], ["$s", s], ["$m", u], ["$H", g], ["$W", p], ["$M", $], ["$y", D], ["$D", R]].forEach((function(h) {
        _e[h[1]] = function(l) {
          return this.$g(l, h[0], h[1]);
        };
      })), _.extend = function(h, l) {
        return h.$i || (h(l, le, _), h.$i = !0), _;
      }, _.locale = ce, _.isDayjs = B, _.unix = function(h) {
        return _(1e3 * h);
      }, _.en = O[S], _.Ls = O, _.p = {}, _;
    }));
  })(me)), me.exports;
}
var Ee = Ue();
const K = /* @__PURE__ */ ye(Ee);
var fe = { exports: {} }, Ye = fe.exports, Me;
function qe() {
...
var Be = qe();
const We = /* @__PURE__ */ ye(Be);
var ge = { exports: {} }, Pe = ge.exports, Se;
function He() {
  return Se || (Se = 1, (function(e, t) {
    (function(i, r) {
      ...
      return function(i, r, o) {
        ...
        function u(p, y, $, j) {
          return n.fromToBase(p, y, $, j);
        }
        o.en.relativeTime = s, n.fromToBase = function(p, y, $, j, D) {
          for (var R, Y, X, ee = $.$locale().relativeTime || s, te = i.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], ie = te.length, q = 0; q < ie; q += 1) {
            var S = te[q];
            S.d && (R = j ? o(p).diff($, S.d, !0) : $.diff(p, S.d, !0));
            var O = (i.rounding || Math.round)(Math.abs(R));
            if (X = R > 0, O <= S.r || !S.r) {
              O <= 1 && q > 0 && (S = te[q - 1]);
              var V = ee[S.l];
              D && (O = D("" + O)), Y = typeof V == "string" ? V.replace("%d", O) : V(O, y, S.l, X);
              break;
            }
          }
          if (y) return Y;
          var B = X ? ee.future : ee.past;
          return typeof B == "function" ? B(Y) : B.replace("%s", Y);
        }, n.to = function(p, y) {
          return u(p, y, this, !0);
        }, n.from = function(p, y) {
          return u(p, y, this);
...
var Ge = He();
const Ve = /* @__PURE__ */ ye(Ge);
var we = { exports: {} }, Je = we.exports, Oe;
function Ze() {
...
const $e = {
  ...
  getRelativeDateFromNow(e) {
    return K(e).locale("en-web3-modal").fromNow(!0);
  },
  formatDate(e, t = "DD MMM") {
    return K(e).format(t);
  }
}, tt = 3, he = 0.1, it = ["receive", "deposit", "borrow", "claim"], rt = ["withdraw", "repay", "burn"], Z = {
  getTransactionGroupTitle(e, t) {
    const i = $e.getYear(), r = $e.getMonthNameByIndex(t);
    return e === i ? r : `${r} ${e}`;
  },
  getTransactionImages(e) {
    const [t] = e;
    return (e == null ? void 0 : e.length) > 1 ? e.map((r) => this.getTransactionImage(r)) : [this.getTransactionImage(t)];
  },
  ...
  getTransactionImageURL(e) {
    var o, n, s, u, g;
    let t;
    const i = !!(e != null && e.nft_info), r = !!(e != null && e.fungible_info);
    return e && i ? t = (s = (n = (o = e == null ? void 0 : e.nft_info) == null ? void 0 : o.content) == null ? void 0 : n.preview) == null ? void 0 : s.url : e && r && (t = (g = (u = e == null ? void 0 : e.fungible_info) == null ? void 0 : u.icon) == null ? void 0 : g.url), t;
  },
  ...
  getTransactionDescriptions(e, t) {
    var j;
    const i = (j = e == null ? void 0 : e.metadata) == null ? void 0 : j.operationType, r = t || (e == null ? void 0 : e.transfers), o = r && r.length > 0, n = r && r.length > 1, s = o && r.every((D) => !!(D != null && D.fungible_info)), [u, g] = r || [];
    let p = this.getTransferDescription(u), y = this.getTransferDescription(g);
    if (!o)
      return (i === "send" || i === "receive") && s ? (p = Te.getTruncateString({
        string: e == null ? void 0 : e.metadata.sentFrom,
        charsStart: 4,
        charsEnd: 6,
        truncate: "middle"
      }), y = Te.getTruncateString({
        string: e == null ? void 0 : e.metadata.sentTo,
        charsStart: 4,
        charsEnd: 6,
        truncate: "middle"
      }), [p, y]) : [e.metadata.status];
    if (n)
      return r == null ? void 0 : r.map((D) => this.getTransferDescription(D));
    let $ = "";
    return it.includes(i) ? $ = "+" : rt.includes(i) && ($ = "-"), p = $.concat(p), [p];
  },
  getTransferDescription(e) {
    var i;
    let t = "";
    return e && (e != null && e.nft_info ? t = ((i = e == null ? void 0 : e.nft_info) == null ? void 0 : i.name) || "-" : e != null && e.fungible_info && (t = this.getFungibleTransferDescription(e) || "-")), t;
  },
  getFungibleTransferDescription(e) {
    var r;
    return e ? [this.getQuantityFixedValue(e == null ? void 0 : e.quantity.numeric), (r = e == null ? void 0 : e.fungible_info) == null ? void 0 : r.symbol].join(" ").trim() : null;
  },
  mergeTransfers(e) {
    if ((e == null ? void 0 : e.length) <= 1)
      return e;
    const i = this.filterGasFeeTransfers(e).reduce((o, n) => {
      var g;
      ...
      if (r.length === 1) {
        ...
        if (o.length === 1 && n.length === 1) {
          ...
          if (s && u) {
            ...
            y < p * he ? (i.push(s), g = !0) : p < y * he && (i.push(u), g = !0);
          }
          g || i.push(...r);
        } else {
  ...
  filterGasFeesFromTokenGroup(e) {
    if (e.length <= 1)
      return e;
    const t = e == null ? void 0 : e.map((u) => Number(u.quantity.numeric)), i = Math.max(...t), r = Math.min(...t), o = 0.01;
    if (r < i * o)
      return e == null ? void 0 : e.filter((g) => Number(g.quantity.numeric) >= i * o);
    const n = e == null ? void 0 : e.filter((u) => u.direction === "in"), s = e == null ? void 0 : e.filter((u) => u.direction === "out");
  ...
  getQuantityFixedValue(e) {
    return e ? parseFloat(e).toFixed(tt) : null;
  }
};
var be;
(function(e) {
...
var U = function(e, t, i, r) {
  ...
  else for (var u = e.length - 1; u >= 0; u--) (s = e[u]) && (n = (o < 3 ? s(n) : o > 3 ? s(t, i, n) : s(t, i)) || n);
...
let N = class extends se {
  ...
  handleImageError(t) {
    return (i) => {
      i.stopPropagation(), this.failedImageUrls.add(t), this.requestUpdate();
    };
  }
  render() {
    const [t, i] = this.images;
    this.images.length || (this.dataset.noImages = "true");
    const r = (t == null ? void 0 : t.type) === "NFT", o = i != null && i.url ? i.type === "NFT" : r, n = r ? "var(--apkt-borderRadius-3)" : "var(--apkt-borderRadius-5)", s = o ? "var(--apkt-borderRadius-3)" : "var(--apkt-borderRadius-5)";
  ...
  templateVisual() {
    const [t, i] = this.images;
    return this.images.length === 2 && (t != null && t.url || i != null && i.url) ? this.renderSwapImages(t, i) : t != null && t.url && !this.failedImageUrls.has(t.url) ? this.renderSingleImage(t) : (t == null ? void 0 : t.type) === "NFT" ? this.renderPlaceholderIcon("nftPlaceholder") : this.renderPlaceholderIcon("coinPlaceholder");
  }
  renderSwapImages(t, i) {
    return w`<div class="swap-images-container">
      ${t != null && t.url ? this.renderImageOrFallback(t, "first", !0) : null}
      ${i != null && i.url ? this.renderImageOrFallback(i, "last", !0) : null}
    </div>`;
  }
  renderSingleImage(t) {
    return this.renderImageOrFallback(t, void 0, !1);
  }
  renderImageOrFallback(t, i, r = !1) {
    return t.url ? this.failedImageUrls.has(t.url) ? r && i ? this.renderFallbackIconInContainer(i) : this.renderFallbackIcon() : w`<wui-image
      src=${t.url}
      alt="Transaction image"
      @onLoadError=${this.handleImageError(t.url)}
    ></wui-image>` : null;
  }
  renderFallbackIconInContainer(t) {
    return w`<div class="swap-fallback-container ${t}">${this.renderFallbackIcon()}</div>`;
  }
  renderFallbackIcon() {
    return w`<wui-icon
      size="xl"
  ...
  renderPlaceholderIcon(t) {
    return w`<wui-icon size="xl" weight="regular" color="default" name=${t}></wui-icon>`;
  }
  templateIcon() {
    let t = "accent-primary", i;
    return i = this.getIcon(), this.status && (t = this.getStatusColor()), i ? w`
...
U([
  I()
], N.prototype, "status", void 0);
U([
  I()
], N.prototype, "direction", void 0);
U([
  I({ type: Boolean })
], N.prototype, "onlyDirectionIcon", void 0);
U([
  I({ type: Array })
], N.prototype, "images", void 0);
U([
  I({ type: Object })
], N.prototype, "secondImage", void 0);
U([
  Q()
], N.prototype, "failedImageUrls", void 0);
N = U([
  ae("wui-transaction-visual")
], N);
const ot = oe`
  :host {
    width: 100%;
...
let L = class extends se {
  ...
  templateDescription() {
    var i;
    const t = (i = this.descriptions) == null ? void 0 : i[0];
    return t ? w`
  ...
  templateSecondDescription() {
    var i;
    const t = (i = this.descriptions) == null ? void 0 : i[1];
    return t ? w`
...
let H = class extends se {
  ...
  swapTemplate() {
    const [t, i] = this.images;
    return this.images.length === 2 && (t || i) ? w`
      ...
      ` : t ? w`<wui-image src=${t} alt="Swap image"></wui-image>` : null;
  }
  fiatTemplate() {
    return w`<wui-icon
      class="fallback-icon"
  ...
  tokenTemplate() {
    const [t] = this.images;
    return t ? w`<wui-image src=${t} alt="Token image"></wui-image> ` : w`<wui-icon
      class="fallback-icon"
...
De.styles = [Ce, at];
De = ut([
  ae("wui-transaction-list-item-loader")
], De);
const ct = oe`
  :host {
    min-height: 100%;
...
const Ae = "last-transaction", lt = 7;
let k = class extends se {
  constructor() {
    super(), this.unsubscribe = [], this.paginationObserver = void 0, this.page = "activity", this.caipAddress = pe.state.activeCaipAddress, this.transactionsByYear = F.state.transactionsByYear, this.loading = F.state.loading, this.empty = F.state.empty, this.next = F.state.next, F.clearCursor(), this.unsubscribe.push(pe.subscribeKey("activeCaipAddress", (t) => {
      t && this.caipAddress !== t && (F.resetTransactions(), F.fetchTransactions(t)), this.caipAddress = t;
    }), pe.subscribeKey("activeCaipNetwork", () => {
  ...
  updateTransactionView() {
    F.resetTransactions(), this.caipAddress && F.fetchTransactions(xe.getPlainAddress(this.caipAddress));
  }
  ...
  templateRenderTransaction(t, i) {
    const { date: r, descriptions: o, direction: n, images: s, status: u, type: g, transfers: p, isAllNFT: y } = this.getTransactionListItemProps(t);
    return w`
  ...
  templateLoading() {
    return this.page === "activity" ? w` <wui-flex flexDirection="column" width="100%">
  ...
  onReceiveClick() {
    Fe.push("WalletReceive");
  }
  createPaginationObserver() {
    const { projectId: t } = Re.state;
    this.paginationObserver = new IntersectionObserver(([i]) => {
      i != null && i.isIntersecting && !this.loading && (F.fetchTransactions(xe.getPlainAddress(this.caipAddress)), Ne.sendEvent({
        type: "track",
        event: "LOAD_MORE_TRANSACTIONS",
        properties: {
          address: xe.getPlainAddress(this.caipAddress),
          projectId: t,
          cursor: this.next,
          isSmartAccount: Le(pe.state.activeChain) === je.ACCOUNT_TYPES.SMART_ACCOUNT
        }
      }));
    }, {}), this.setPaginationObserver();
  }
  setPaginationObserver() {
    ...
    const t = (r = this.shadowRoot) == null ? void 0 : r.querySelector(`#${Ae}`);
    t && ((o = this.paginationObserver) == null || o.observe(t));
  }
  getTransactionListItemProps(t) {
    var g, p, y;
    const i = $e.formatDate((g = t == null ? void 0 : t.metadata) == null ? void 0 : g.minedAt), r = Z.mergeTransfers((t == null ? void 0 : t.transfers) || []), o = Z.getTransactionDescriptions(t, r), n = r == null ? void 0 : r[0], s = !!n && (r == null ? void 0 : r.every(($) => !!$.nft_info)), u = Z.getTransactionImages(r);
    return {
      date: i,
      ...
      isAllNFT: s,
      images: u,
      status: (p = t.metadata) == null ? void 0 : p.status,
      transfers: r,
      type: (y = t.metadata) == null ? void 0 : y.operationType
    };
  }
};
k.styles = ct;
G([
  I()
], k.prototype, "page", void 0);
G([
  Q()
], k.prototype, "caipAddress", void 0);
G([
  Q()
], k.prototype, "transactionsByYear", void 0);
G([
  Q()
], k.prototype, "loading", void 0);
G([
  Q()
], k.prototype, "empty", void 0);
G([
  Q()
], k.prototype, "next", void 0);
k = G([
  ae("w3m-activity-list")
], k);
//# sourceMappingURL=index-JTdkfKxL.mjs.map
