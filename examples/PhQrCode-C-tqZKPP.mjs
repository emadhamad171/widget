import { n as s, Y as i, t, p as A, O as Z, s as p } from "./property-Bd8U3_QP.mjs";
var l = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = (e, v, H, V) => {
  for (var h = V > 1 ? void 0 : V ? n(v, H) : v, m = e.length - 1, o; m >= 0; m--)
    (o = e[m]) && (h = (V ? o(v, H, h) : o(h)) || h);
  return V && h && l(v, H, h), h;
};
...
//# sourceMappingURL=PhQrCode-C-tqZKPP.mjs.map
