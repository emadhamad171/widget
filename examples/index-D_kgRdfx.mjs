import { Z as G, _ as L, $ as F, a0 as A, a1 as O, a2 as b, a3 as C, a4 as Y, a5 as V, a6 as j, a7 as k, a8 as B, a9 as J, aa as U, ab as H, ac as Q, ad as m, ae as S } from "./index-DIokOUOA.mjs";
import { af as st } from "./index-DIokOUOA.mjs";
      ...
      if (typeof window < "u" && (window == null ? void 0 : window.parent) !== window) {
        if (!d) {
          const { default: t } = await (() => {
            try {
              return import("./index-RSkMjky4.mjs");
            } catch {
          ...
          const o = await (async () => {
            const n = await (() => {
              try {
                return import("./index-C7HCQadr.mjs").then((s) => s.i);
              } catch {
    ...
    async getProvider({ chainId: e } = {}) {
      ...
      async function c() {
        ...
        const { EthereumProvider: l } = await (() => {
          try {
            return import("./index-DLVuXqPN.mjs").then((a) => a.i);
          } catch {
...
//# sourceMappingURL=index-D_kgRdfx.mjs.map
