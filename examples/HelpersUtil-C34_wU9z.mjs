import { j as f, r as g, l as p, m as h, R as v, O as u, q as $ } from "./index-DIokOUOA.mjs";
import { n as m } from "./class-map-tAR3WI_8.mjs";
import { c as y } from "./index-COpezuDz.mjs";
import { C as c } from "./ConstantsUtil-BLOMW2TZ.mjs";
const b = f`
  :host {
    display: flex;
...
var d = function(t, e, r, a) {
  var n = arguments.length, o = n < 3 ? e : a === null ? a = Object.getOwnPropertyDescriptor(e, r) : a, s;
...
let i = class extends p {
  ...
  render() {
    ...
    const e = this.size === "md" ? "md-medium" : "sm-medium", r = this.size === "md" ? "md" : "sm";
    return h`
...
const O = {
  getTabsByNamespace(t) {
    var r;
    return !!t && t === $.CHAIN.EVM ? ((r = u.state.remoteFeatures) == null ? void 0 : r.activity) === !1 ? c.ACCOUNT_TABS.filter((a) => a.label !== "Activity") : c.ACCOUNT_TABS : [];
  },
  isValidReownName(t) {
  ...
  validateReownName(t) {
    return t.replace(/\^/gu, "").toLowerCase().replace(/[^a-zA-Z0-9]/gu, "");
  },
  hasFooter() {
    var e;
    const t = v.state.view;
    if (c.VIEWS_WITH_LEGAL_FOOTER.includes(t)) {
      const { termsConditionsUrl: r, privacyPolicyUrl: a } = u.state, n = (e = u.state.features) == null ? void 0 : e.legalCheckbox;
      return !(!r && !a || n);
    }
...
//# sourceMappingURL=HelpersUtil-C34_wU9z.mjs.map
