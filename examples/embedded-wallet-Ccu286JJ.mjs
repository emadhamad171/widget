import { n as Y, l as g, M as W, O as K, m as c, z as _, T as j, ag as G, j as E, r as z, k as B, d as N, C as m, ah as V, q as k, t as C, W as h, o as L, ai as q, aj as v, a as D, E as O, S as X, R as Q } from "./index-DHmMKAfZ.mjs";
import { r as d, n as l } from "./class-map-B6nE1eS1.mjs";
import { c as w } from "./index-mXeXqCx8.mjs";
import "./index-CoemqBpY.mjs";
import { e as Z, n as J } from "./ref-cmmbpERb.mjs";
import "./index-hJDCPUxP.mjs";
import { H as I } from "./HelpersUtil-COwUmCyU.mjs";
import { o as ee } from "./if-defined-DMrep62h.mjs";
...
import { N as te } from "./NavigationUtil-kj9LEOOd.mjs";
const ie = Y`
  div {
    width: 100%;
  }
...
let R = class extends g {
  ...
  async syncTheme() {
    ...
    if (t) {
      const i = j.getSnapshot().themeMode, r = j.getSnapshot().themeVariables;
...
let $ = class extends g {
  ...
  isV6() {
    return (V.get("dapp_smart_account_version") || "v6") === "v6";
  }
  toggleSmartAccountVersion() {
    var t;
    V.set("dapp_smart_account_version", this.isV6() ? "v7" : "v6"), typeof window < "u" && ((t = window == null ? void 0 : window.location) == null || t.reload());
  }
  ...
  async changePreferredAccountType() {
    ...
    _.getAuthConnector() && (this.loading = !0, await L.setPreferredAccountType(r, t), this.text = r === h.ACCOUNT_TYPES.SMART_ACCOUNT ? "Switch to your EOA" : "Switch to your Smart Account", this.switched = !0, q.resetSend(), this.loading = !1, this.requestUpdate());
  }
};
A([
  d()
...
let p = class extends g {
  ...
  async onSubmitName(t) {
    try {
      ...
      X.showError(i.message), O.sendEvent({
        type: "track",
...
//# sourceMappingURL=embedded-wallet-Ccu286JJ.mjs.map
