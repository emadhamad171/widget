import { j as U, r as Ie, k as ve, l as _, m as l, q as I, aw as Se, o as v, ax as ke, ay as y, a as O, az as _e, aA as N, O as ce, N as A, aB as me, C as m, F as T, E as M, S as R, y as Ce, M as G, s as $e, i as Re, p as Oe, z as P, R as z, v as Ue, n as Le } from "./index-DIokOUOA.mjs";
import { n as b, r as h, a as Ne } from "./class-map-tAR3WI_8.mjs";
import { o as f } from "./if-defined-gnHLSuzV.mjs";
import { c as C, U as qe } from "./index-COpezuDz.mjs";
...
import "./index-CqgTitxX.mjs";
import "./index-DT5kI7JL.mjs";
import "./index-DMXVUC4w.mjs";
import { M as ge } from "./MathUtil-3Rm1Yovd.mjs";
const De = U`
  :host {
    position: relative;
  }
...
function ne(t, e) {
  const { chainNamespace: n, chainId: s } = y.parseCaipNetworkId(t), i = Ze[n];
  if (!i)
  ...
  return e !== "native" ? (a = i.defaultTokenNamespace, o = e) : n === "eip155" && xe[s] && (o = xe[s]), `${`${n}:${s}`}/${a}:${o}`;
}
function et(t) {
...
const be = 0, se = "unknown", ae = "direct-transfer", it = "deposit", at = "transaction", r = Oe({
  paymentAsset: {
    network: "eip155:1",
    asset: "0x0",
    metadata: {
    ...
    if (r.currentPayment = {
      ...
      try {
        ...
        switch (N.isLowerCaseMatch(c == null ? void 0 : c.caipNetworkId, o.caipNetworkId) || await m.switchActiveNetwork(o), t) {
          case I.CHAIN.EVM:
            i.asset === "native" && (r.currentPayment.result = await je(i, t, {
              recipient: n,
              amount: s,
              fromAddress: e
...
ee([
  b({ type: Array })
], j.prototype, "options", void 0);
ee([
  b()
], j.prototype, "selectedPaymentAsset", void 0);
ee([
  b()
], j.prototype, "onSelect", void 0);
j = ee([
  C("w3m-pay-options")
], j);
const Nt = U`
...
//# sourceMappingURL=index-DSeKedk1.mjs.map
