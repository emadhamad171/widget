import { j as O, l as _, z as S, O as h, V as W, R as f, d as T, m as c, a as C, X as F, x as D, C as d, o as P, E as u, H as A, S as v, Y as N, M as R, T as y } from "./index-DKNltDvP.mjs";
import { n as j, r as l } from "./class-map-DWmnpxTI.mjs";
import { o as $ } from "./if-defined-CkYnLk1h.mjs";
import { c as I } from "./index-lXSzxGsb.mjs";
import { O as U } from "./index-vOvTwTHG.mjs";
import { e as M } from "./index-reWJQjg7.mjs";
import "./index-D9uLo7Tj.mjs";
import { C as z } from "./ConstantsUtil-BLOMW2TZ.mjs";
...
let p = class extends _ {
  constructor() {
    super(), this.unsubscribe = [], this.tabIdx = void 0, this.connectors = S.state.connectors, this.authConnector = this.connectors.find((e) => e.type === "AUTH"), this.remoteFeatures = h.state.remoteFeatures, this.isPwaLoading = !1, this.hasExceededUsageLimit = W.state.plan.hasExceededUsageLimit, this.unsubscribe.push(S.subscribeKey("connectors", (e) => {
  ...
  render() {
    ...
    return (!o || !r) && !n ? null : (n && !r && (e = T.DEFAULT_SOCIALS), c` <wui-flex flexDirection="column" gap="2">
...
let m = class extends _ {
  constructor() {
    ...
    super(), this.unsubscribe = [], this.socialProvider = (o = d.getAccountData()) == null ? void 0 : o.socialProvider, this.socialWindow = (r = d.getAccountData()) == null ? void 0 : r.socialWindow, this.error = !1, this.connecting = !1, this.message = "Connect in the provider window", this.remoteFeatures = h.state.remoteFeatures, this.address = (n = d.getAccountData()) == null ? void 0 : n.address, this.connectionsByNamespace = P.getConnections(d.state.activeChain), this.hasMultipleConnections = this.connectionsByNamespace.length > 0, this.authConnector = S.getAuthConnector(), this.handleSocialConnection = async (i) => {
      ...
      if ((s = i.data) != null && s.resultUri)
        if (i.origin === z.SECURE_SITE_ORIGIN) {
    ...
    }, N.EmbeddedWalletAbortController.signal.addEventListener("abort", () => {
  ...
  loaderTemplate() {
    const e = y.state.themeVariables["--w3m-border-radius-master"], o = e ? parseInt(e.replace("px", ""), 10) : 4;
...
let w = class extends _ {
  ...
  qrCodeTemplate() {
    if (!this.uri || !this.ready)
      return null;
    const e = this.getBoundingClientRect().width - 40, o = y.state.themeVariables["--apkt-qr-color"] ?? y.state.themeVariables["--w3m-qr-color"];
...
w = x([
  I("w3m-connecting-farcaster-view")
], w);
export {
...
//# sourceMappingURL=socials-uLRnTHmo.mjs.map
