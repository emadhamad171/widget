import { C as S, o as g, O as p, E as c, M as _, R as s, S as f, a as C, j as D, l as b, z as d, m as u, n as $, U as W, q as P } from "./index-DKNltDvP.mjs";
import { c as m } from "./index-lXSzxGsb.mjs";
import { W as y } from "./index-BJ3KxEcI.mjs";
import { r as E } from "./class-map-DWmnpxTI.mjs";
import "./index-D9uLo7Tj.mjs";
import "./index-DgnbtPXE.mjs";
import { e as N, n as T } from "./ref-CzOvar1n.mjs";
...
let h = class extends b {
  constructor() {
    var e, t;
    super(...arguments), this.formRef = N(), this.initialEmail = ((e = s.state.data) == null ? void 0 : e.email) ?? "", this.redirectView = (t = s.state.data) == null ? void 0 : t.redirectView, this.email = "", this.loading = !1;
  }
  firstUpdated() {
    var e;
    ...
    super(), this.email = (e = s.state.data) == null ? void 0 : e.email, this.onOtpSubmit = async (t) => {
      try {
        ...
        throw c.sendEvent({
          type: "track",
          event: "EMAIL_VERIFICATION_CODE_FAIL",
          properties: { message: C.parseError(r) }
        }), r;
      }
    }, this.onStartOver = () => {
...
let v = class extends b {
  ...
  checkIfAuthEnabled(e) {
    ...
    return P.AUTH_CONNECTOR_SUPPORTED_CHAINS.some((n) => t.includes(n));
  }
};
V([
  E()
...
//# sourceMappingURL=email-kOc7owVS.mjs.map
